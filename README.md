...
* Data para entrega no prazo regular: `04/05/2023 14:00`.
...
* Use o comando: `git clone git@github.com:tryber/sd-023-a-project-algorithms.git`.
...
* Crie uma branch à qual você vai submeter os `commits` do seu projeto
  ...
  * Exemplo: `git checkout -b joaozinho-sd-023-a-project-algorithms`
...
* Usando o exemplo anterior: `git push -u origin joaozinho-sd-023-a-project-algorithms`

  7. Crie um novo `Pull Request` _(PR)_

* Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-023-a-project-algorithms/pulls)
...
* Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-023-a-project-algorithms/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH23-A&template=betrybe/sd-0x-project-algorithms)
